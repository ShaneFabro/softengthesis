...
@section('content')
    ...
    <h1>No Info</h1>
    <br>
    <a href="{{ route('dean.beforeedit', auth()->user()->id) }}" class="btn btn-info">Add Personal Particular</a>
    </div>
                ...
                <div class="col-md-8">
                    <div class="card card-default">
                        <div class="card-header bg-primary">
                            ...
                            <a href="{{ route('dean.edit', auth()->user()->personalParticular->user_id) }}" class="btn btn-success float-right">Edit</a>
                        </div>
                        <div class="card-body">
