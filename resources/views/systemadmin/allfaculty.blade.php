                ...
                <tr>
                    ...
                    <td>
                        @if($member->is_active == 1)
                            <form action="{{ route('admin.activedeactivate', $member->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <input type="submit" name="submit" class="btn btn-warning" value="Deactivate">
                            </form>
                        @else
                            <form action="{{ route('admin.activedeactivate', $member->id) }}" method="POST">
                                @csrf
                    ...
                    <td><a href="{{ route('admin.edit', $member->id) }}" class="btn btn-info">Edit</a></td>
                    <td>
                        <form action="{{ route('admin.destroy', $member->id) }}" method="POST">
                            @csrf
                            @method('DELETE')
                            <input type="submit" name="submit" class="btn btn-danger" value="Archive">
                        </form>
                    </td>
                </tr>
                @endforeach
