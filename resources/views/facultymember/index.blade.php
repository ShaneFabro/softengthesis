                            ...
                            <table class="table">
                                ...
                                <tbody> 
                                    <tr>
                                        ...
                                        <td>{{ auth()->user()->academicPresentStatus->validate == 0 ? 'On Approval' : 'Approved'}}</td>
                                    </tr>
                                </tbody>
                            </table>
                        @else
                    ...
                    <div class="card card-default">
                            ...
                            <table class="table">
                                ...
                                <tbody> 
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $employmentHistoryTeachingExperiences->validate == 0 ? 'On Approval' : 'Approved'}}</td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
                            ...
                            <table class="table">
                                ...
                                <tbody> 
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $employmentHistoryAdminisExperiences->position_title }}</td>
                                        <td>{{ $employmentHistoryAdminisExperiences->validate == 0 ? 'On Approval' : 'Approved'}}</td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
                        ...
                        <tbody> 
                            ...
                            <tr>
                                ...
                                <td>{{ $employmentHistoryProfPracOutTeaching->position_title }}</td>
                                <td>{{ $employmentHistoryProfPracOutTeaching->validate == 0 ? 'On Approval' : 'Approved'}}</td>
                            </tr>
                            @endforeach
                        </tbody>
                        </table>
                        ...
                        <table class="table">
                                ...
                                <tbody> 
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $employmentHistoryExchangeProgram->position_title }}</td>
                                        <td>{{ $employmentHistoryExchangeProgram->validate == 0 ? 'On Approval' : 'Approved'}}</td>
                                    </tr>
                                    @endforeach
                                </tbody>
                                </table>
                                ...
                                <table class="table">
                                    ...
                                    <tbody> 
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $nondegreetrainingSeminarsWorkshops->venue }}</td>
                                            <td>{{ \Carbon\Carbon::parse($nondegreetrainingSeminarsWorkshops->inclusive_date)->format('M d Y') }}</td>
                                            <td>{{ $nondegreetrainingSeminarsWorkshops->validate == 0 ? 'On Approval' : 'Approved'}}</td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                </table>
                                ...
                                <table class="table">
                                    ...
                                    <tbody> 
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $nondegreetrainingCulturalEducationalTravel->venue }}</td>
                                            <td>{{ \Carbon\Carbon::parse($nondegreetrainingCulturalEducationalTravel->inclusive_date)->format('M d Y') }}</td>
                                            <td>{{ $nondegreetrainingCulturalEducationalTravel->validate == 0 ? 'On Approval' : 'Approved' }}</td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                </table>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-12">
                            <div class="card card-default">
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody> 
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $researchScholarPubRefers->validate == 0 ? 'On Approval' : 'Approved'}}</td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
                                    ...
                                    <table class="table">
                                            ...
                                            <tbody> 
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $researchScholarPubNonRefers->validate == 0 ? 'On Approval' : 'Approved'}}</td>
                                                </tr>
                                                @endforeach
                                            </tbody>
                                    </table>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody> 
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $researchScholarFullBooks->validate == 0 ? 'On Approval' : 'Approved'}}</td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody> 
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $researchScholarPreNonScribePubBooks->validate == 0 ? 'On Approval' : 'Approved'}}</td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody> 
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $researchScholarProfJournals->validate == 0 ? 'On Approval' : 'Approved'}}</td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody> 
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $researchScholarLocJournals->validate == 0 ? 'On Approval' : 'Approved'}}</td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody> 
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $researchScholarDelPubPaper->validate == 0 ? 'On Approval' : 'Approved'}}</td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody> 
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $researchScholarCommCompResearches->validate == 0 ? 'On Approval' : 'Approved'}}</td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody> 
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $researchScholarResearchPosters->validate == 0 ? 'On Approval' : 'Approved' }}</td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody> 
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $researchCreativeDistPerfArts->validate == 0 ? 'On Approval' : 'Approved' }}</td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody> 
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $researchCreativeOrigMusicalWorks->validate == 0 ? 'On Approval' : 'Approved' }}</td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody> 
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $researchCreateOrigDesigns->validate == 0 ? 'On Approval' : 'Approved' }}</td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody> 
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $researchCreativeLitWorks->validate == 0 ? 'On Approval' : 'Approved' }}</td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody> 
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $researchCreativeExArtWorks->validate == 0 ? 'On Approval' : 'Approved'}}</td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody> 
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $researchCreativeGenCirculations->validate == 0 ? 'On Approval' : 'Approved' }}</td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody> 
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $researchCreativeAidTechMatProdCourseModules->validate == 0 ? 'On Approval' : 'Approved' }}</td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody> 
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $researchCreativeAidTechMatProdOnlineCourses->validate == 0 ? 'On Approval' : 'Approved' }}</td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
                                ...
                                @if(auth()->user()->researchCreativeAidTechMatProdManuals()->count() > 0)
                                    <table class="table">
                                        <thead>
                                            <th>Nature of publication (book/textbook, journal article, newspaper article, research publication)</th>
                                            <th>Date of Publication</th>
                                        ...
                                        <tbody> 
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $researchCreativeAidTechMatProdManuals->validate == 0 ? 'On Approval' : 'Approved' }}</td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody> 
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $researchCreativeAidTechTechAids->validate == 0 ? 'On Approval' : 'Approved' }}</td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody> 
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $commExtServiceCommServiceDevUnivInitiates->validate == 0 ? 'On Approval' : 'Approved' }}</td>
                                                </tr>
                                                @endforeach
                                            </tbody>
                                        </table>
                                    ...
                                    <table class="table">
                                            ...
                                            <tbody> 
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $commExtServiceCommServiceDevExtInitiates->validate == 0 ? 'On Approval' : 'Approved' }}</td>
                                                </tr>
                                                @endforeach
                                            </tbody>
                                        </table>
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody> 
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $commExtServiceCommServiceHumanUnivInitiates->title}}</td>
                                                    <td>{{ $commExtServiceCommServiceHumanUnivInitiates->role }}</td>
                                                    <td>{{ $commExtServiceCommServiceHumanUnivInitiates->validate == 0 ? 'On Approval' : 'Approved' }}</td>
                                                </tr>
                                                @endforeach
                                            </tbody>
                                        </table>
                                    ...
                                    <table class="table">
                                            ...
                                            <tbody> 
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $commExtServiceCommServiceHumanExtInitiates->validate == 0 ? 'On Approval' : 'Approved' }}</td>
                                                </tr>
                                                @endforeach
                                            </tbody>
                                        </table>
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody> 
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $commExtServiceCommServiceAdvoUnivInitiates->validate == 0 ? 'On Approval' : 'Approved' }}</td>
                                                </tr>
                                                @endforeach
                                            </tbody>
                                        </table>
                                    ...
                                    <table class="table">
                                            ...
                                            <tbody> 
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $commExtServiceCommServiceAdvoExtInitiates->validate == 0 ? 'On Approval' : 'Approved' }}</td>
                                                </tr>
                                                @endforeach
                                            </tbody>
                                        </table>
                                ...
                                <table class="table">
                                        ...
                                        <tbody> 
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $commExtserviceExtserviceSeminars->validate == 0 ? 'On Approval' : 'Approved'}}</td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody> 
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $commExtserviceExtserviceProfStandOffInternationals->validate == 0 ? 'On Approval' : 'Approved' }}</td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
                                ...
                                <table class="table">
                                        ...
                                        <tbody> 
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $commExtserviceExtserviceProfStandOffNationals->validate == 0 ? 'On Approval' : 'Approved' }}</td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody> 
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $commExtserviceExtserviceProfStandOffAcadInternationals->validate == 0 ? 'On Approval' : 'Approved' }}</td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
                                ...
                                <table class="table">
                                        ...
                                        <tbody> 
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $commExtserviceExtserviceProfStandOffAcadNationals->validate == 0 ? 'On Approval' : 'Approved' }}</td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody> 
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $commExtserviceExtserviceManWorkGovernments->validate == 0 ? 'On Approval' : 'Approved' }}</td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
                                ...
                                <table class="table">
                                        ...
                                        <tbody> 
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $commExtserviceExtserviceManWorkPrivates->validate == 0 ? 'On Approval' : 'Approved' }}</td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody> 
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $commExtserviceExtserviceManWorkSeniors->validate == 0 ? 'On Approval' : 'Approved' }}</td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
                                ...
                                <table class="table">
                                        ...
                                        <tbody> 
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $commExtserviceExtserviceConsultWorks->validate == 0 ? 'On Approval' : 'Approved' }}</td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
                                ...
                                <table class="table">
                                        ...
                                        <tbody> 
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $commExtserviceExtserviceGuestAppearances->validate == 0 ? 'On Approval' : 'Approved' }}</td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody> 
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $honorsReceivedGovernments->validate == 0 ? 'On Approval' : 'Approved' }}</td>
                                                </tr>
                                                @endforeach
                                            </tbody>
                                        </table>
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody> 
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $honorsReceivedScholarships->validate == 0 ? 'On Approval' : 'Approved' }}</td>
                                                </tr>
                                                @endforeach
                                            </tbody>
                                        </table>
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody> 
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $honorsReceivedAwards->validate == 0 ? 'On Approval' : 'Approved' }}</td>
                                                </tr>
                                                @endforeach
                                            </tbody>
                                        </table>
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody> 
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $useOfTechnologies->validate == 0 ? 'On Approval' : 'Approved' }}</td>
                                                </tr>
                                                @endforeach
                                            </tbody>
                                        </table>
