...
@endsection
 ...
 @section('content')
     <h2 class="text-center">Faculty Member <strong>{{ $user->name }}</strong> of {{ $user->rank->name }}</h2>
                     ...
                     <div class="card card-default">
                         ...
                         <div class="row">
                                <div class="card-body ml-4 col-md-5">
                                    ...
                                    <br>
                                    <br>
                                    <strong>Name of Spouse:</strong> {{ $user->personalParticular->spouse == null ? 'Not Applicable' : $user->spouse }}
                                    <br>
                                    <br>
                                    <strong>Names and Ages of Children:</strong> {{ $user->personalParticular->names_ages_of_children == null ? 'Not Applicable' : $user->names_ages_of_children }}
                                </div>
                                <div class="col-md-3 col-md-offset-2">
                                    <img src="{{ $user->personalParticular->image ? asset('storage/' . $user->personalParticular->image) : 'https://via.placeholder.com/430x400' }}" alt="" width="430" height="400">
                                </div>
                            </div>
                         @else
